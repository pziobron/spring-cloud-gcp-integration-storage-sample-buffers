...
public class ImprovedGcsSessionFactory implements SessionFactory<BlobInfo>, SharedSessionCapable {

  private Storage gcs;

  public ImprovedGcsSessionFactory(Storage gcs) {
  ...
  public Session<BlobInfo> getSession() {
    return new ImprovedGcsSession(this.gcs);
  }
